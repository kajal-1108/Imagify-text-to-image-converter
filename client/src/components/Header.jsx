...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      gap-2 bg-white px-6 rounded-full border border-neutral-500'
      ...
      sm:max-w-[590px] mx-auto mt-10 text-center'>Turn text to<span
       ...
       > Unleash your creativity with AI. Turn your 
        imagination into visual art in seconds - just type, and
        ...
        >
            ...
            >
                {Array(6).fill('').map((item,index)=>(
                    ...
                    src={index % 2 === 0 ? assets.sample_img_2 : assets.sample_img_1} alt="" key={index} 
                    width={70}/>
                ))}
            </motion.div>
            ...
            className='mt-2 text-neutral-600'>Generated images from PixelMuse</motion.p>
    </motion.div>
  )
}
